...
public class FolderAdapter extends RecyclerView.Adapter<FolderAdapter.MyHolder> {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        holder.filesCount.setText(String.valueOf(NumberOfFiles(folderName.get(position))));
    ...
    static class MyHolder extends RecyclerView.ViewHolder {
        TextView folder,filesCount;
        public MyHolder(@NonNull View itemView) {
            super(itemView);
            folder = itemView.findViewById(R.id.folderName);
            filesCount = itemView.findViewById(R.id.count_files_folder);
        }
    }
